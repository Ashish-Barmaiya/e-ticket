...
const EventCard = ({ id, image, title, artist, date, venue, city, price }) => {
  return (
    <Link href={`/events/${id}/details`} className="block">
      <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white hover:shadow-lg hover:shadow-gray-500 transition duration-300 cursor-pointer">
        <img className="w-full h-60 object-contain" src={image} alt={title} />
